...
const DEFAULT_WORDS = ["TOOLS", "MANIA", "WELCOME", "TO", "TOOLS MANIA"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
  ...
  const animate = useCallback(() => {
    ...
    if (frameCountRef.current % 240 === 0) {
      ...
      const currentWord = words[wordIndexRef.current] ?? DEFAULT_WORDS[0]!
  ...
  useEffect(() => {
    ...
    const initialWord = words[0] ?? DEFAULT_WORDS[0]!
